                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                        <div class="relative w-full md:w-1/3 group">
                            <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400 group-focus-within:text-indigo-500 transition-colors">
                                <img src="{{ asset('meta-buscar/matricula.jpeg') }}" alt="Buscar" class="w-10 h-10 object-contain rounded">
                            </span>
                            <input wire:model.live.debounce.300ms="search" type="text" 
                                   class="w-full pl-14 pr-4 py-3 bg-white border-2 border-gray-200 rounded-xl text-sm shadow-md focus:ring-4 focus:ring-indigo-100 focus:border-indigo-500 transition-all outline-none" 
                        ...
                        <button wire:click="create"
                            ...
                            <img src="{{ asset('meta-register/matricula.png') }}"
                                alt="Registrar Matrícula"
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div class="flex justify-end space-x-2">
                                                ...
                                                <button wire:click="edit({{ $m->id }})"
                                                    ...
                                                    title="Editar">
                                                    <img src="{{ asset('meta-editar/matricula.jpeg') }}"
                                                        alt="Editar"
                                                        class="w-12 h-12 object-contain">
                                                </button>
                                                ...
                                                <button wire:click="confirmDelete({{ $m->id }})"
                                                    ...
                                                    title="Eliminar">
                                                    <img src="{{ asset('meta-eliminar/matricula.jpeg') }}"
                                                        alt="Eliminar"
                                                        class="w-12 h-12 object-contain">
                                                </button>
                                            </div>
                ...
                <div class="p-8 max-w-5xl mx-auto animate-fade-in">
                    <form wire:submit.prevent="save" class="space-y-10">
                        ...
                        <div class="flex flex-col sm:flex-row justify-end gap-4 mt-12 pt-10 border-t border-gray-100">
                            <button type="button" wire:click="closeModal" class="px-8 py-3 text-sm font-bold text-red-600 bg-red-50 border-2 border-red-200 rounded-lg hover:bg-red-100 hover:border-red-300 hover:text-red-700 active:scale-95 transition-all duration-150 uppercase tracking-widest shadow-sm">
                                Cancelar
                            </button>
                            @if ($view == 'create')
                                <button type="submit"
                                    class="h-14 px-6 flex items-center justify-center bg-[#98FB98] text-black font-bold rounded-2xl hover:bg-[#7FE67F] transition shadow-lg active:scale-95">
                                    <span wire:loading class="mr-2 animate-spin h-4 w-4 border-2 border-black border-t-transparent rounded-full"></span>
                                    <img src="{{ asset('meta-register/matricula.png') }}"
                                        alt="Procesar Matrícula"
                            ...
                            @else
                                <button type="submit"
                                    class="h-14 px-6 flex items-center justify-center bg-[#98FB98] text-black font-bold rounded-2xl hover:bg-[#7FE67F] transition shadow-lg active:scale-95">
                                    <span wire:loading class="mr-2 animate-spin h-4 w-4 border-2 border-black border-t-transparent rounded-full"></span>
                                    <img src="{{ asset('meta-guardar/matricula.jpeg') }}"
                                        alt="Guardar Cambios"
