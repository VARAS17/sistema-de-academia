                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                        <div class="relative w-full md:w-1/3 group">
                            ...
                            <input wire:model.live.debounce.300ms="search" type="text" 
                                   class="w-full pl-10 pr-4 py-2.5 bg-gray-50 border-gray-200 rounded-xl text-sm focus:border-indigo-500 focus:bg-white transition-all outline-none" 
                        ...
                        <button wire:click="showCreate" 
                            ...
                            <div class="relative inline-flex items-center justify-center w-6 h-6 mr-2 flex-shrink-0">
                                <img src="{{ asset('metaforas/SIMULACROS.svg') }}?v={{ time() }}" class="w-full h-full object-contain">
                                    ...
                                    <tr class="hover:bg-indigo-50/30 transition-colors group">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <div class="flex justify-center space-x-2">
                                                <button wire:click="showEdit({{ $sim->id }})" class="p-2 text-indigo-600 hover:bg-indigo-100 rounded-lg transition-colors relative inline-flex items-center justify-center flex-shrink-0" title="Editar">
                                                    <img src="{{ asset('metaforas/SIMULACROS.svg') }}?v={{ time() }}" class="w-10 h-10 object-contain flex-shrink-0">
                                                ...
                                                <button wire:click="abrirConfirmacionEliminacion({{ $sim->id }})" class="p-2 text-rose-500 hover:bg-rose-50 rounded-lg transition-colors relative inline-flex items-center justify-center flex-shrink-0" title="Eliminar">
                                                    <img src="{{ asset('metaforas/SIMULACROS.svg') }}?v={{ time() }}" class="w-10 h-10 object-contain flex-shrink-0">
