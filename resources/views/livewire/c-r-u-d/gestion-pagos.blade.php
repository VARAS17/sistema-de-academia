                        ...
                        <div class="mb-8 flex flex-col md:flex-row justify-between items-center gap-4">
                            <div class="relative w-full md:w-1/3 group">
                                <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400 group-focus-within:text-indigo-500 transition-colors">
                                    <img src="{{ asset('meta-buscar/pago.jpeg') }}" alt="Buscar" class="w-10 h-10 object-contain rounded">
                                </span>
                                    ...
                                    <tr class="hover:bg-indigo-50/30 transition-colors group">
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div class="flex justify-end space-x-2">
                                                <!-- Ver detalle -->
                                                <button wire:click="verDetalle({{ $pago->id }})"
                                                    class="p-2 hover:bg-indigo-100 rounded-lg transition-colors"
                                                    title="Ver Detalle">

                                                    <img src="{{ asset('meta-ver/pago.jpeg') }}"
                                                        alt="Ver"
                                                ...
                                                @hasanyrole('admin|docente')
                                                    @if($pago->estado !== 'Pagado')
                                                        <!-- Registrar pago -->
                                                        <button wire:click="registrarPago({{ $pago->id }})"
                                                            class="p-2 hover:bg-emerald-50 rounded-lg transition-colors"
                                                            title="Subir / Verificar Voucher">

                                                            <img src="{{ asset('metaforas/subir.jpeg') }}"
                                                                alt="Registrar Pago"
                                                                class="w-10 h-10 object-contain">
                                                        </button>
                                                    @endif
                                                ...
                                                <!-- Descargar PDF -->
                                                <button wire:click="exportarPDF({{ $pago->id }})"
                                                    class="p-2 hover:bg-red-50 rounded-lg transition-colors"
                                                    title="Descargar Boleta">

                                                    <img src="{{ asset('metaforas/generar.jpeg') }}"
                                                        alt="PDF"
                                                        class="w-10 h-10 object-contain">
                                                </button>
                                            </div>
