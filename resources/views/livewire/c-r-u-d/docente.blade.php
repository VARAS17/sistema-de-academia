                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                        ...
                        <button wire:click="create" class="w-full md:w-auto px-6 py-2.5 bg-indigo-600 text-white font-bold rounded-xl hover:bg-indigo-700 transition shadow-lg shadow-indigo-100 flex items-center justify-center active:scale-95">
                            <div class="relative inline-flex items-center justify-center w-6 h-6 mr-2 flex-shrink-0">
                                <img src="{{ asset('metaforas/DOCENTE.svg') }}?v={{ time() }}" class="w-full h-full object-contain">
                                    ...
                                    <tr class="hover:bg-indigo-50/30 transition-colors group">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <div class="flex justify-center space-x-1">
                                                <button wire:click="show({{ $docente->user_id }})" class="p-2 text-indigo-600 hover:bg-indigo-100 rounded-lg transition-colors relative inline-flex items-center justify-center">
                                                    <img src="{{ asset('metaforas/DOCENTE.svg') }}" class="w-10 h-10 object-contain">
                                                ...
                                                <button wire:click="edit({{ $docente->user_id }})" class="p-2 text-amber-600 hover:bg-amber-50 rounded-lg transition-colors relative inline-flex items-center justify-center flex-shrink-0" title="Editar">
                                                    <img src="{{ asset('metaforas/DOCENTE.svg') }}?v={{ time() }}" class="w-10 h-10 object-contain flex-shrink-0">
                                                ...
                                                <button wire:click="confirmDelete({{ $docente->user_id }})" class="p-2 text-red-500 hover:bg-red-50 rounded-lg transition-colors relative inline-flex items-center justify-center flex-shrink-0" title="Eliminar">
                                                    <img src="{{ asset('metaforas/DOCENTE.svg') }}?v={{ time() }}" class="w-10 h-10 object-contain flex-shrink-0">
