                                    ...
                                    <tr class="hover:bg-indigo-50/30 transition-colors group">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <div class="flex justify-center space-x-1">
                                                ...
                                                <button wire:click="confirmDelete({{ $docente->user_id }})" class="p-2 text-red-500 hover:bg-red-50 rounded-lg transition-colors" title="Eliminar">
                            ...
                            <div class="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-bold text-gray-800">{{ \Carbon\Carbon::parse($selectedDocente->fecha_contratacion)->format('d \d\e M, Y') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="p-8">
                    <form wire:submit.prevent="store" class="max-w-5xl mx-auto space-y-8">
                        ...
                        <div class="mt-10 p-6 bg-gray-50/50 rounded-2xl border-2 border-dashed border-gray-100">
                            ...
                            @error('selectedCursos') <p class="text-red-500 text-[10px] font-bold uppercase mt-4 ml-1">{{ $message }}</p> @enderror
                        </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-6">
                        ...
                        <p class="mt-2 text-sm text-gray-500 font-medium leading-relaxed">
                            Esta acción eliminará la cuenta del docente y su perfil profesional de forma permanente. No se podrán recuperar sus datos de contacto ni especialidad.
                        </p>
                    </div>
                </div>
            </div>
