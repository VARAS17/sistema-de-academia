                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                        <div class="relative w-full md:w-1/3 group">
                            <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400 group-focus-within:text-indigo-500 transition-colors">
                                <img src="{{ asset('meta-buscar/curso.jpeg') }}" alt="Buscar" class="w-12 h-12 object-contain rounded">
                            </span>
                ...
                <div class="p-8 max-w-4xl mx-auto">
                    ...
                    <form wire:submit.prevent="store" class="space-y-6">
                        ...
                        <div class="flex flex-col sm:flex-row justify-end gap-4 mt-12 pt-8 border-t border-gray-100">
                            <button type="button" wire:click="volver" class="px-8 py-3 text-sm font-bold text-red-600 bg-red-50 border-2 border-red-200 rounded-lg hover:bg-red-100 hover:border-red-300 hover:text-red-700 active:scale-95 transition-all duration-150 uppercase tracking-widest shadow-sm">
                                Cancelar
                            </button>
                            @if ($view == 'create')
                                <button type="submit"
                                    ...
                                    <span wire:loading wire:target="store" class="mr-2 animate-spin h-4 w-4 border-2 border-black border-t-transparent rounded-full"></span>
                                    <img src="{{ asset('meta-register/curso.png') }}"
                                        alt="Registrar Curso"
                                        class="w-17 h-17 mr-2 object-contain"
                            ...
                            @else
                                <button type="submit"
                                    class="h-14 px-6 flex items-center justify-center bg-[#98FB98] text-black font-bold rounded-xl hover:bg-[#7FE67F] transition shadow-lg active:scale-95">
                                    <span wire:loading wire:target="store" class="mr-2 animate-spin h-4 w-4 border-2 border-black border-t-transparent rounded-full"></span>
                                    <img src="{{ asset('meta-guardar/curso.jpeg') }}"
                                        alt="Actualizar Curso"
                                        class="w-17 h-17 mr-2 object-contain"
                                        wire:loading.remove wire:target="store">
                                    Guardar Curso
                                </button>
